...
public class BoardServiceImplTest {
	...
	public void testCreateBoard(){
		Board board = boardService.create("My Board", "Board Description", "userid999", "fav.png");
	...
	public void testFindAll() {  
		Board board1 = boardService.create("Sarah's Board", "A board for Sarah", "sarah", "fav.png");
		Board board2 = boardService.create("Sarah's SecondBoard", "A second board for Sarah", "sarah", "fav.png");
		Board board3 = boardService.create("John's Board", "A board for John", "john", "fav.png");
		Board notIncluded = boardService.create("Sally's Board", "", "", "fav.png");
	...
	public void testFindByUserId() {  
		...
		Board board2 = boardService.create("Sarah's SecondBoard", "A second board for Sarah", "sarah", "fav.png");
		Board board3 = boardService.create("John's Board", "A board for John", "john", "fav.png");
		Board notIncluded = boardService.create("Sally's Board", "", "sally", "fav.png");
	...
	public void testUpdate() {  
		...
		boardService.update(board1.getId(), board1.getName(), board1.getDescription(), "fav.png");
		...
		boardService.update(board2.getId(), board2.getName(), board2.getDescription(), "fav.png");
