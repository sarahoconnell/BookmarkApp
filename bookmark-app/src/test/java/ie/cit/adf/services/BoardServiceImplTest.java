...
public class BoardServiceImplTest {
	...
	public void testCreateBoard(){
		Board board = boardService.create("My Board", "Board Description", "userid999");
	...
	public void testFindAll() {  
		Board board1 = boardService.create("Sarah's Board", "A board for Sarah", "sarah");
		Board board2 = boardService.create("Sarah's SecondBoard", "A second board for Sarah", "sarah");
		Board board3 = boardService.create("John's Board", "A board for John", "john");
		Board notIncluded = boardService.create("Sally's Board", "", "");
	...
	public void testFindByUserId() {  
		...
		Board board2 = boardService.create("Sarah's SecondBoard", "A second board for Sarah", "sarah");
		Board board3 = boardService.create("John's Board", "A board for John", "john");
		Board notIncluded = boardService.create("Sally's Board", "", "sally");
	...
	public void testUpdate() {  
		...
		boardService.update(board1.getId(), board1.getName(), board1.getDescription());
		...
		boardService.update(board2.getId(), board2.getName(), board2.getDescription());
